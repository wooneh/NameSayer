...
public class RecordAudio extends Task<Void> {
	...
	protected Void call() throws IOException, InterruptedException {
		...
		recordAudioCommand.add("ffmpeg -f alsa -i default -t 5 \"" + _filePath + "\"");

		//recordAudioCommand.add("CMD");
		//recordAudioCommand.add("/C");
		//recordAudioCommand.add("ffmpeg -f dshow -i audio=\"Microphone (Realtek High Definition Audio)\" -t 5 \"" + _filePath + "\"");
